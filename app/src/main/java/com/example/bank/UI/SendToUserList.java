...
import com.example.bank.DB.TransactionHelper;
import com.example.bank.DB.UserHelper;
import com.example.bank.Data.User;
import com.example.bank.ListAdapters.SendToUserAdapter;
import com.example.bank.DB.TransactionContract.TransactionEntry;
import com.example.bank.DB.TransactionHelper;
import com.example.bank.DB.UserContract.UserEntry;
import com.example.bank.DB.UserHelper;
import com.example.bank.Data.User;
import com.example.bank.ListAdapters.SendToUserAdapter;
...
public class SendToUserList extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    ...
    public void onUserClick(int position) {
        ...
        startActivity(new Intent(SendToUserList.this, SplashScreen.class));
        finish();
    }
